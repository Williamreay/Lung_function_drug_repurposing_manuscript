...
#Ever vs never smoked - GTEx v7 Nucleus accumbens
...
--chr ${chr} \
--out ~/data/users/william/Cytokine_pneumonia_lung_function/Smoking_TWAS/NAc_results/Ever_smoked_NAc/Ever_smoked_NAc_chr${chr}_FUSION
done
