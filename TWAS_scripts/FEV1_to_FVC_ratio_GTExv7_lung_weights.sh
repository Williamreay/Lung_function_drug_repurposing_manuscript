...
#FEV1:FVC ratio - GTEx v7 Lung weights

for chr in $(seq 1 22);
do
Rscript ~/data/users/william/fusion_twas-master/FUSION.assoc_test.R \
--sumstats ~/data/users/william/Cytokine_pneumonia_lung_function/TWAS/Munged_TWAS_input/Munged_FEV1_FVC_ratio_meta.sumstats.gz \
...
--chr ${chr} \
--out ~/data/users/william/Cytokine_pneumonia_lung_function/TWAS/GTEx_lung_v7_results/FEV1_FVC_ratio_results/FEV1_to_FVC_Lung_chr${chr}_FUSION
done
